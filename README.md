This is code to put a simple test, with a few questions, and simple yes/no count scoring, into a shortcode in WordPress, so it can be inserted as a button.
